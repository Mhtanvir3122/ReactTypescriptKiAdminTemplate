// src/data/apexcharts/lineColumnComboChartData.ts
import { ApexOptions } from "apexcharts";

const lineColumnComboChartData = {
  series: [
    {
      name: "Website Blog",
      type: "column",
