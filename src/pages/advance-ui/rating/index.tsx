...
import RatingBar from "@/components/advancedui/rating/RatingBar.tsx";
import SquareRating from "@/components/advancedui/rating/SquareRating.tsx";
import PillRating from "@/components/advancedui/rating/PillRating.tsx";
import ReversedRating from "@/components/advancedui/rating/ReversedRating.tsx";
import HorizontalRating from "@/components/advancedui/rating/HorizontalRating.tsx";
        ...
        <Row>
            ...
            <Card className="equal-card">
              ...
              <Card.Body>
                <div className="box-body">
                  <SquareRating initial={1} onChange={(val) => console.log("Selected:", val)} />
                </div>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col md="6" xxl="4">
            <Card className="equal-card">
              ...
              <Card.Body>
                <div className="boxs box-orange box-example-1to10 p-4">
                  <RatingBar initial={7} onChange={(val) => console.log("Selected:", val)} />
                </div>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col md="6" xxl="4">
            <Card className="equal-card">
              ...
              <Card.Body>
                ...
                <ReversedRating onChange={(value) => console.log("Selected index:", value)} />
                </div>
              </Card.Body>
            </Card>
          </Col>
                  ...
                  <div className="rating-container mt-4">
                    {[0, 1, 2, 3, 4].map((index) => (
                      <FontAwesomeIcon
                        key={`rating-${index}`}
                        icon={faStar}
                        className={`emoji-star ${
                          index <= activeRating ? "active" : ""
                        }`}
