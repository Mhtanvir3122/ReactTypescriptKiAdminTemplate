...
import { usersList, variantList } from "@/data/uikit/lists/listPageData.ts";
          ...
          <Card.Body>
            <ListGroup className="list-group list-content">
              {usersList.map((user, index) => (
                <ListGroupItem
                  key={user.id}
                  className={`list-group-item list-group-item-action flex-wrap ${index === 0 ? "active" : ""}`}
                ...
                >
                  ...
                  <div className="mg-s-60">
                    <h6 className="mb-0 txt-ellipsis-1">{user.name}</h6>
                    <p className="mb-0 text-secondary">{user.email}</p>
                    <div className="mt-2">
                      <p className="mb-0">{user.message}</p>
                    </div>
                  </div>
                  <div className="flex-shrink-0 text-end w-100">
