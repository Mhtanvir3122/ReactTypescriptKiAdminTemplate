    ...
    <Row>
                  ...
                  <div className="d-flex">
                    <div className="me-3">
                      <div className="d-flex align-items-center">
                        ...
                        />
                        <div
                          className={`w-40 d-flex-center b-r-50 position-relative`}
                        >
                          <img
                            src={contact.avatar}
                            alt={contact.name}
          ...
          <Card.Body className="p-0">
            <div className="list-group list-group-flush app-scroll overflow-auto list-people">
              {Object.entries(peopleList).map(([key, peoples]) => (
                <div
                  key={key}
                  className="sticky-top bg-white p-l-10 f-w-500 f-s-16"
                >
                  {/* Key for the group */}
                    ...
                    <div className="list-group-item" key={data.id}>
                      <Row>
                        <Col className="col-auto">
                          <a href="#">
                            <div
                              className={`h-40 w-40 d-flex-center b-r-10 overflow-hidden ms-2 ${data.bgColor} `}
                            >
                              <img
                                src={data.image}
                                alt={data.name}
                        ...
                        <Col className="col p-0 text-truncate">
      ...
      <Col md={6} xxl={4}>
        <Card className="overflow-hidden">
          ...
          <Card.Body className=" bg-light-light">
