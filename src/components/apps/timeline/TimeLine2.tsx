          ...
          {timelineData.map((item, index) => (
            ...
            >
              <div className="side-timeline-icon">
                <span
                  className={`text-light-${item.color} d-flex align-items-center justify-content-center rounded-circle avatar-25`}
                >
                  <IconCircleFilled
                    size={16}
              ...
              <div className="timeline-content">
                <div className="mb-2">
                  <Card.Title className={`text-${item.color} mb-1`}>
                    {item.title}
                  </Card.Title>
                ...
                <Card.Text className="mb-1 text-dark">
                  {item.description}{" "}
                  <Card.Link href={item.moreInfoLink} className="text-primary">
                    [more info]
                  </Card.Link>
                </Card.Text>
                {item.tags && (
                  <div className="mt-2">
                    {item.tags.map((tag, tagIndex) => (
                      <Badge key={tagIndex} bg={item.color} className="me-2">
                        {tag}
                      </Badge>
                    ))}
                  </div>
