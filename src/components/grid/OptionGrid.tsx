...
const breakpoints: Breakpoint[] = [
  { name: "Extra small", icons: "<", value: "576px" },
  { name: "Small", icons: "≥", value: "576px" },
  { name: "Medium", icons: "≥", value: "768px" },
  { name: "Large", icons: "≥", value: "992px" },
  { name: "Extra large", icons: "≥", value: "1200px" },
  { name: "Extra extra large", icons: "≥", value: "1400px" },
];
                ...
                <tr>
                  ...
                  {breakpoints.map((bp, i) => (
                    <th key={i} className="app-grid">
                      ...
                      <br />
                      <small>
                        <span className="w-12">{bp.icons}</span>{" "}
                        {bp.value}
                      </small>
                    </th>
                  ))}
